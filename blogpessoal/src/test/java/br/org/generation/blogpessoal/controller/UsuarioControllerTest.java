...
public class UsuarioControllerTest {
	...
	public void deveBuscarPorId() {
		usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Lailo Francielo", "lailo@email.com.br", "lailo123", " "));
			
		usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Benedita Maria", "benedita@email.com.br", "benedita123", " "));
	...
	@Test
	@Order(6)
	@DisplayName("Quando não encontra o id")
	void DeveVoltarIdInexistente() {
		usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Lailo Ricardo dos Santos", "lailo@email.com.br", "lailo123", " "));
			
		usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Bruno Marquezino Neyminino", "marquezino@email.com.br", "marquezino123", " "));
			
		ResponseEntity<String> resposta = testRestTemplate
				.withBasicAuth("root", "root")
				.exchange("/usuarios/21", HttpMethod.GET, null, String.class);
